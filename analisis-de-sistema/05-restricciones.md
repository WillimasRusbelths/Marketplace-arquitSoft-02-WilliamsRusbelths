...
| RC06 | Documentación en Markdown | Los documentos de análisis y arquitectura del laboratorio deben redactarse en archivos Markdown. |
| RC07 | Diagrama arquitectónico | El diagrama de arquitectura debe elaborarse con Draw.io o Mermaid. |